...
/**
 * The MIDIParseError class is an error that can be thrown by the various
 * MIDI Parser objects when they encounter invalid MIDI protocol bytes, or invalid
 * Standard MIDI File bytes
 */


public class MIDIParseError extends Error
{
    /**
     * 
     */
    ...
    public MIDIParseError()
    {
        super();
    }
    
    public MIDIParseError( String reason )
    {
        super( reason );
    }
}
